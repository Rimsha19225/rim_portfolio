...
export default async function Home() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#9C27B0] to-[#4A148C] overflow-x-hidden pb-10">
      <MainPageText/>
      <hr className="w-full max-w-[90%] md:max-w-[70%] h-[2px] border-none bg-gradient-to-l from-[#fff] to-black m-auto" />
      <hr className="w-full max-w-[90%] md:max-w-[70%] h-[2px] border-none bg-gradient-to-l from-[#fff] to-black m-auto mt-1"/>
      <SkillBarText/>
      <hr className="w-full max-w-[90%] md:max-w-[70%] h-[2px] border-none bg-gradient-to-l from-[#fff] to-black m-auto"/>
      <hr className="w-full max-w-[90%] md:max-w-[70%] h-[2px] border-none bg-gradient-to-l from-[#fff] to-black m-auto mt-1"/>
      <AboutText/>
      ...
      <div className="py-10 px-4 max-w-5xl mx-auto">
        <h2 className="text-[2rem] md:text-[3rem] font-bold text-black mb-6 md:mb-8 text-center drop-shadow-md text-shadow-[0_3px_5px_#fff]">
          Skills <span className="text-[#fff] text-shadow-[0_4px_8px_#000]">Progress
          </span>
        </h2>
      ...
      <hr className="w-full max-w-[90%] md:max-w-[70%] h-[2px] border-none bg-gradient-to-l from-[#c119e0] to-black m-auto"/>
      <hr className="w-full max-w-[90%] md:max-w-[70%] h-[2px] border-none bg-gradient-to-l from-[#c119e0] to-black m-auto mt-1"/>
      <ServicesText/>
      <hr className="w-full max-w-[90%] md:max-w-[70%] h-[2px] border-none bg-gradient-to-l from-[#c119e0] to-black m-auto"/>
      <hr className="w-full max-w-[90%] md:max-w-[70%] h-[2px] border-none bg-gradient-to-l from-[#c119e0] to-black m-auto mt-1"/>
      <div className="py-10 px-4 max-w-5xl mx-auto">
        <h2 className="text-[2rem] md:text-[3rem] font-bold text-black mb-6 md:mb-8 text-center drop-shadow-md text-shadow-[0_3px_5px_#fff]">
          What <span className="text-[#fff] text-shadow-[0_0px_0px_#fff]">People Say!</span>
        </h2>
        {messages.length > 0 && <MessageSlider messages={messages} />}
        <div className="flex justify-center mt-6"><Link href={"/review"}><button className="px-3 md:px-6 py-2 md:py-3 bg-[#000] rounded-xl text-[#fff] hover:shadow-[0_0_16px_#fff] text-[0.8rem] md:text-[1rem]">Drop Message ✎𓂃</button></Link></div>
      </div>
      <hr className="w-full max-w-[90%] md:max-w-[70%] h-[2px] border-none bg-gradient-to-l from-[#fff] to-black m-auto"/>
      <hr className="w-full max-w-[90%] md:max-w-[70%] h-[2px] border-none bg-gradient-to-l from-[#fff] to-black m-auto mt-1"/>
      <LatestProjects/>
